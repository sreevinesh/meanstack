var isl=[
    ...
    {team:"atk",played:17,won:11,draw:4,lose:2,pts:30},
    {team:"goa",played:16,won:12,draw:3,lose:3,pts:34},
...
var newdata=isl.sort((h1,h2)=>h1.pts>h2.pts?1:-1).forEach(o=>console.log(o))